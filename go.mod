...
require (
	...
	github.com/ossf/osv-schema/bindings/go v0.0.0-20231208180642-4e4b2b7b8b5c
...
require (
	...
	github.com/google/uuid v1.6.0 // indirect; bumped from v1.5.0 to pick up minor fixes
